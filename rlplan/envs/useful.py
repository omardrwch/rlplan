...
class TwoRoomSparseHard(GridWorld):
    """
    Same geometry as TwoRoomSparse, but with confusing rewards.
    """
    def __init__(self, nrows=3,
                 ncols=3,
                 success_probability=1.0,
        ...
        self.goal_coord = (nrows - 1, ncols - 1)
        self.confusing_1 = (nrows - 1, 0)
        self.confusing_2 = (0, ncols - 1)
        start_coord = (0, 0)
        reward_at = {self.goal_coord: 1, self.confusing_1: 0.25, self.confusing_2: 0.25}
        terminal_states = (self.goal_coord, )
        default_reward = 0.0
